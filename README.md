This is as basic twitter bot that will allow you to retweet items basic on a search string. It will also respond to users who follow it with a short message. It is based on the walkthroughs found here:
